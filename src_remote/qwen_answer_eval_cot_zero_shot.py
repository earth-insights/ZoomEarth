...
def evaluate_dataset(base):
    ...
    for item in tqdm(base):
        ...
        answer = extract_tag(item.get('answer1', '').split("Now apply to a new question")[-1], 'answer')
        # print(answer)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_file", type=str, default="./results/lora_infer_zero_shot_cot.jsonl")
