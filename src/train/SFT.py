...
"""
        ...
        if example['bbox'] != []:
            stage_1 = process_stage_1_reasoning(example['stage_1_reasoning'], [point / 2 for point in example['bbox']], example['label'])
        else:
            stage_1 = example['stage_1_reasoning']
        if example['cut']:
            label = (
            ...
            image2 = resize_image(cut_image(image=image1, bbox=[example['scale'] * item for item in example['bbox']]))
