...
"""
        match task_type:
            case _:
                return "Given the question: \"{Question}\", please provide the bounding box where you can find the asnwer to the question. First output the thinking process in <think> </think> tags and then output the final answer (the bbox) in <answer> </answer> tags. Output the bounding box of that region as pixel coordinates in the form <bbox>[x1,y1,x2,y2]</bbox>. Use integers, no spaces"
